...
} as const satisfies Record<string, (t: number, b: number, _c: number, d: number, s: number) => number>;

export function createTween(easingFunction: Function, b: number, c: number, d: number, s?: number) {
